#include "SampleAnalyzer/cms_exo_23_003_CRDY/Analyzer/cms_exo_23_003_CRDY.h"
using namespace MA5;
using namespace std;
...
// -----------------------------------------------------------------------------
MAbool cms_exo_23_003_CRDY::Initialize(const MA5::Configuration& cfg,
...
// -----------------------------------------------------------------------------
bool cms_exo_23_003_CRDY::Execute(SampleFormat& sample, const EventFormat& event)
{
...
// -----------------------------------------------------------------------------
void cms_exo_23_003_CRDY::Finalize(const SampleFormat& summary, const std::vector<SampleFormat>& files)
{
}
